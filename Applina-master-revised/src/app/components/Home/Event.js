...
const data = [
  {
    img: "/Seerah2.png",
    title: "Prototype Review Sessions",
  },
  {
  ...
  {
    img: "/SportsDay1.png",
    title: "Research Workshops & Study Groups",
  },
  {
    img: "/BakeSale2.png",
  ...
  return (
    <div className='w-full items-center justify-center flex pb-16 pt-24'>
      <div className='w-[90%] sm:w-1/2 md:w-[94%] xl:w-4/5 items-center justify-center flex flex-col'>
        <h1 className='mainHeading text-textBlack text-3xl font-bold'>RESEARCH & EDUCATION</h1>
          ...
          >
            {data.map((item, index) => (
              <SwiperSlide key={index}>
                <div
                  className='my-16 pt-4 pb-6 rounded-3xl px-4 flex flex-col items-center w-[95%] justify-center relative 
                ...
                >
                  ...
                  <YellowButton title={"See More"} link={"/research-education"} px={6} py={1.5} />
                </div>
              </SwiperSlide>
            ))}
          </Swiper>

        ...
        <div className="flex flex-col items-center justify-center gap-8 relative xl:h-[100vh] lg:h-[100vh] h-[85vh]">
          <div className="text-center z-20 px-10">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white tracking-wide mb-4 max-w-6xl mx-auto">
              The AI Research & Prototype Playground for Health and Wellness
            </h2>
            <p className="text-sm sm:text-lg md:text-xl lg:text-2xl text-white/90 max-w-5xl mx-auto">
              Researchers, builders, and health organizations can publish prototypes, explore realistic scenarios, gather structured feedback, and evaluate whether an artifact is relevant before investing in data collection for research or beginning outreach to potential provider partners.
            </p>
          </div>

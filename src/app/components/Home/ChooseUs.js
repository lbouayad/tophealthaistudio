...
const ChooseUs = () => {
  const pillStyle =
    "absolute flex flex-row top-0 left-0 rounded-full gap-x-4 w-[19.5rem] items-center bg-orange p-4 z-40";
  const pillStyleSmall =
    "flex flex-row top-0 left-0 rounded-full gap-x-4 w-[19.5rem] items-center bg-orange p-4 z-40 mt-10";

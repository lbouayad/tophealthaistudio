        ...
        <>
            <div className='w-full md:h-[64rem] h-[40rem] xl:pt-[23rem] md:pt-80 sm:pt-60 pt-52 xl:pl-64 lg:pl-10 pl-1 relative' style={backgroundImageStyle}>
                <div className='flex flex-col items-center justify-center text-center xl:w-2/5 lg:w-1/2 md:w-3/5 sm:w-1/2 w-[70%]'>
                    ...
                    <h1 
                        className='md:text-[57px] text-3xl md:leading-[4rem] font-bold text-yellow'
                        style={{ textShadow: "-6px 0 2px #5B5C5C, 0 0 5px #5B5C5C" }}
                    >
                        RESPONSIBLE AI
                    </h1>

                    <h1 className='md:text-5xl text-2xl font-bold text-blue sm:my-10 my-8 xl:w-[96%]'>
                        Join the Prototype & Research Community
                    </h1>

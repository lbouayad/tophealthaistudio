...
import { FaStar, FaRobot, FaCode, FaLightbulb, FaSearch } from "react-icons/fa";
            ...
            <div data-aos="zoom-out" data-aos-duration="1200" data-aos-delay="400"
                ...
                <div className={`relative -left-[30.6rem] -top-[15.2rem]`}>
                    <div className={`${pillStyle}`}>
                        ...
                        <h2 className='text-white w-2/3 text-lg font-bold'>Designed for Responsible AI Validation</h2>
                    </div>
                ...
                <div className={`relative -left-[2.8rem] -top-[15.2rem]`}>
                    <div className={`${pillStyle}`}>
                        ...
                        <h2 className='text-white w-2/3 text-lg font-bold'>Publish, Test & Validate Prototypes</h2>
                    </div>
                ...
                <div className={`relative -left-[36.6rem] -top-[3rem]`}>
                    <div className={`${pillStyle}`}>
                        ...
                        <h2 className='text-white w-2/3 text-lg font-bold'>Grounded in Real-World Context</h2>
                    </div>
                ...
                <div className={`relative left-[3rem] -top-[3rem]`}>
                    <div className={`${pillStyle}`}>
                        ...
                        <h2 className='text-white w-2/3 text-lg font-bold'>Accessible to Technical and Non-Technical Users</h2>
                    </div>
                ...
                <div className={`relative -left-[30.7rem] top-[9rem]`}>
                    <div className={`${pillStyle}`}>
                        ...
                        <h2 className='text-white w-2/3 text-lg font-bold'>Better Than a Simple Code Repository</h2>
                    </div>
                ...
                <div className={`relative -left-[3rem] top-[9rem]`}>
                    <div className={`${pillStyle}`}>
                        ...
                        <h2 className='text-white w-2/3 text-lg font-bold'>Built for Research, Relevance, and Early Decision-Making</h2>
                    </div>

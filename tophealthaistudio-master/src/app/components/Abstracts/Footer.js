        ...
        <div className='w-full flex md:flex-row flex-col lg:pl-0 md:pl-10'>
          <div className='lg:w-3/5 md:w-1/2 flex flex-col items-start'>
            <ul className="text-sm font-medium space-y-1">
              ...
              >
                <Image src={"/google-icon-andriod.svg"} width={200} height={200} alt='Learning platform' className='h-16 w-auto object-cover object-center' />
          ...
          <div className="lg:w-2/5 md:w-1/2 mt-12 lg:mt-0 md:mt-6 xl:pl-10 pl-0">
            <ul className="text-base md:text-lg font-medium space-y-1">
              ...
              <li className='flex items-center gap-x-2 pt-2'>
                <a className='hover:underline inline-flex items-center gap-x-1' target='_blank' rel="noopener noreferrer" href={"https://tophealthaistudio.org"}>
      ...
      <div className='w-full px-10 mt-10 flex items-center justify-center lg:flex-row flex-col'>
        <div className='mt-8 lg:mt-0 text-center'>
          <p className='text-sm md:text-base'>
            Copyright © {year} All Rights Reserved by <a target='_blank' rel="noopener noreferrer" href="https://tophealthaistudio.org" className='hover:underline font-semibold'>Top Health AI Studio</a>
          </p>
        </div>
      </div>
    </div>

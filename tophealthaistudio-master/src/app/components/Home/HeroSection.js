        ...
        <div className="flex flex-col items-center justify-center gap-10 relative xl:h-[100vh] lg:h-[100vh] h-[84vh]">
          <div className="text-center z-20 px-10">
            ...
            <p className="text-base sm:text-xl md:text-2xl lg:text-3xl text-white/90 max-w-4xl mx-auto mb-4">
              Advancing clinically defensible AI through structured evaluation, interdisciplinary collaboration, and applied education.
            </p>

            <p className="text-sm sm:text-lg md:text-xl lg:text-2xl text-white/90 max-w-4xl mx-auto mb-4">
              Built on real prototype evaluation conducted through Applina — our platform for publishing and testing health AI artifacts in realistic scenarios.
            </p>

            <p className="text-sm sm:text-lg md:text-xl lg:text-2xl text-white/90 max-w-4xl mx-auto">
              We offer applied courses in health AI, clinical accountability training, and evaluation frameworks designed to help clinicians, researchers, and institutions interpret what is worth advancing. CME accreditation is currently in progress, and courses are available through our learning platform.
            </p>
          </div>
